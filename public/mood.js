function init() {
    ...
    post_btn.addEventListener('click', function () {
        if (post_txt.value != "") {
                firebase.database().ref('mood_list').push({
    ...
    var postsRef = firebase.database().ref('mood_list');
    ...
    postsRef.once('value')
        .then(function (snapshot) {
            ...
            for(var key in obj){
                ...
                document.getElementById("post_list").innerHTML += str_before_username + user_email + "</strong>" + '<a href="m_comment.html?' + key + '">' + obj[key].title + '</a>' + str_after_content;
            }
            postsRef.on('value', function(snapshot){
                ...
                for(var key in newobj){
                    ...
                    document.getElementById("post_list").innerHTML += str_before_username + user_email + "</strong>" + '<a href="m_comment.html?' + key + '">' +newobj[key].title + '</a>' + str_after_content;
                }
